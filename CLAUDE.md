...
- [docs/features.md](docs/features.md) — 103개 피처 목록 (v5), 누수 방지 체크리스트
...
- [docs/monetization.md](docs/monetization.md) — 수익화 모델, 구독 티어, 결제(토스페이먼츠), 법적 요건
...
- 금지 표현: "적중", "픽", "배팅", "수익률", "보장", "토토" (도박법 저촉)
