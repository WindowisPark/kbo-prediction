...
- [x] 피처 엔지니어링 v3 (97 피처, 누수 방지)
- [x] ML 모델 3종 (XGBoost 59.9%, ELO 54.4%, EnsembleLGBM 59.6%)
- [x] 멀티 에이전트 토론 (Claude + GPT, 병렬 실행)
...
- [ ] Calibration 검증 + 확률 보정
- [ ] 홈 어드밴티지 최적값 (KBO 실측)
- [ ] 모델 버전 관리 (joblib save/load 활용)
- [ ] Redis 캐싱
- [ ] LLM 비용 대시보드
